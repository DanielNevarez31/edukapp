...
<body>
					...
					<div class="nmt">
						<table class="table table-hover rounded border border-light" id="table">
							...
							<tbody id="tblEstudiantes">
							     <?php include'../../php/alumnos/listar.php'; ?>
							</tbody>
						</table>
					</div>
				</div>
	...
	<div class="modal fade" id="modalDetallesEstudiante" tabindex="-1" role="dialog" aria-labelledby="tituloDetallesEducador" aria-hidden="true">
                        ...
                        <div class="col-12">
                            <div class="nwt">
                                <table class="table table-hover table-striped rounded table-fixed border table-sm" id="tblDatosEmpleado">
                                    ...
                                    <td id="alumnoTitle" class="text-center font-weight-bold" style="font-size: 20px;" colspan="2">Alumno <i class="fas fa-user-graduate"></i></td>
                                    <tr id="alumnoNombre" >
...
<script src="../../js/admin/alumnos.js"></script>
</body>
</html>