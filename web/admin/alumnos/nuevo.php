	...
	<div class="container-fluid d-flex align-items-stretch row m-0 p-0" id="pag">
		...
		<div id="contenido" class="col-md-10 col-sm-12">
			<div class="row mx-1"> <!-- Formulario -->
				<h1 class="col-12 text-center">Registrar un estudiante nuevo</h1>
				<div class="col-12 mt-0">
					<a href="../alumnos/" class="btn grey text-white" data-toggle="tooltip" data-placement="top" title="Ver todos los estudiantes registrados">
...
<script src="../../js/admin/alumnosNuevo.js"></script>
</body>
</html>