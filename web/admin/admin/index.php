...
<body>
					...
					<div class="nmt">
						<table class="table table-hover rounded border border-light" id="table">
							...
							<tbody id="tblEstudiantes">
							    <?php include '../../php/admin/listar.php'; ?>
							</tbody>
						</table>
					</div>
				</div>
	...
	<div class="modal fade" id="modalDetallesAdmin" tabindex="-1" role="dialog" aria-labelledby="tituloDetallesEducador" aria-hidden="true">
                        ...
                        <div class="col-12">
                            <div class="nwt">
                                <table class="table table-hover table-striped rounded table-fixed border table-sm" id="tblDatosEmpleado">
                                    <td class="text-center font-weight-bold" style="font-size: 20px;" colspan="2">Administrador <i class="fas fa-users-cog"></i></td>
                                    <tr>
	...
	<div class="modal fade" id="modalEditarAdmin" tabindex="-1" role="dialog" aria-labelledby="tituloEditarEducador" aria-hidden="true">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
