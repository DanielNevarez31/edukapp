...
<body>
		...
		<div id="contenido" class="col-md-10 col-sm-12">
			<div class="row mx-1 my-2 d-block">
				<ol class="breadcrumb">
					...
					<a href="#" class="breadcrumb-item disabled active">Promociones</a>
				</ol>
			</div>
			<div class="row mx-1 my-1 text-right">
				<div class="col-12">
					<h1 class="text-center">Ver lista de promociones</h1>
				</div>
				...
				<div class="col-12 p-1">
				    <div class="md-form">
						...
						<small class="text-muted">
							Puede buscar promociones por su <b>Titulo</b>, <b>Descripción</b>, o <b>Estado</b>
						</small>
					</div>
					<div class="nmt">
	...
	<div class="modal fade" id="modalDetallesProm" tabindex="-1" role="dialog" aria-labelledby="tituloDetallesProm" aria-hidden="true">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="tituloDetallesProm">Información de la promoción.</h5>
	            ...
	            <div class="modal-body d-flex justify-content-center white">
	                <div class="container row">
                        ...
                        <div class="col-12">
                            <div class="nwt">
                                <table class="table table-hover table-striped rounded table-fixed border table-sm" id="tblDatosProm">
                                    <tr>
	...
	<div class="modal fade" id="modalEditarProm" tabindex="-1" role="dialog" aria-labelledby="tituloEditarProm" aria-hidden="true">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="tituloDetallesProm">Editar información de la promoción</h5>
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                    <span aria-hidden="true">&times;</span>
	                </button>
	            </div>
	            ...
	            <div class="modal-footer">
	                <button type="button" class="btn green accent-4" onclick="updateProm()" id="btnEditarEmpleado">
                        Editar
                    </button>
	                <button type="button" class="btn red accent-4" data-dismiss="modal">
						Cerrar
...
<script type="text/javascript" src="../../../js/admin/promociones.js"></script>
