		...
		<div id="contenido" class="col-md-10 col-sm-12">
			<div class="row mx-1 my-2 d-block">
				<ol class="breadcrumb">
					...
					<a href="../nosotros/" class="breadcrumb-item">Nosotros</a>
					<a href="nuevo.php" class="breadcrumb-item disabled active">Nuevo</a>
				</ol>
			</div>
			<div class="row mx-1"> <!-- Formulario -->
				<h1 class="col-12 text-center">Nueva información sección "Nosotros"</h1>
				<div class="col-12 mt-0">
					<a href="../nosotros/" class="btn grey text-white" data-toggle="tooltip" data-placement="top" title="Ver todos los registros">
						<i class="fas fa-clipboard-list fa-lg"></i>
					</a>
					<button id="registrarNos" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Registrar información">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-6">
								<div class="md-form">
									...
									<label for="descripcion">Descripción de la imagen o información a mostrar</label>
									<small id="descripcionAyuda" class="text-muted">
										Descripción de la imagen o información a mostrar.
									</small>
								</div>
							</div>
							<div class="col-sm-12 col-md-6">
...
<script src="../../../js/admin/nosotrosNuevo.js"></script>
</body>
</html>