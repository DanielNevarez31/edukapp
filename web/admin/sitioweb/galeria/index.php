...
<body>
		...
		<div id="contenido" class="col-md-10 col-sm-12">
			<div class="row mx-1 my-2 d-block">
				<ol class="breadcrumb">
					...
					<a href="#" class="breadcrumb-item disabled active">Galería</a>
				</ol>
			</div>
			<div class="row mx-1 my-1 text-right">
				<div class="col-12">
					<h1 class="text-center">Ver lista de "Galería".</h1>
				</div>
			...
			<div class="row mx-1">
				<div class="col-12 p-1">
				    <div class="md-form">
						...
						<label for="busqueda">Buscar imagen...</label>
						<small class="text-muted">
							Puede buscar imágenes por su <b>Título</b>
						</small>
					</div>
					<div class="nmt">
	...
	<div class="modal fade" id="modalDetallesGal" tabindex="-1" role="dialog" aria-labelledby="tituloDetallesGaleria" aria-hidden="true">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="tituloDetallesGal">Información de la imagen</h5>
	            ...
	            <div class="modal-body d-flex justify-content-center white">
	                <div class="container row">
                        ...
                        <div class="col-12">
                            <div class="nwt">
                                <table class="table table-hover table-striped rounded table-fixed border table-sm" id="tblDatosGaleria">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<img id="tdImagen" src="" width="400px;">
                                        </td>
                                    </tr>
                                </table>
                            </div>
	...
	<div class="modal fade" id="modalEditarGaleria" tabindex="-1" role="dialog" aria-labelledby="tituloEditarSucursal" aria-hidden="true">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="tituloDetallesSucursal">Editar información de la galería</h5>
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                    <span aria-hidden="true">&times;</span>
	                </button>
	            </div>
	            <div class="modal-body d-flex justify-content-center white">
	                <div class="row">
	                    <div class="col-12">
	                        <div class="row">
                                <h3 class="col-sm-12 col-md-6">Información de la imagen</h3>
	            ...
	            <div class="modal-footer">
	                <button type="button" class="btn green accent-4" onclick="updateGal()" id="btnEditarGal">
                        Editar
                    </button>
	                <button type="button" class="btn red accent-4" data-dismiss="modal">
						Cerrar
