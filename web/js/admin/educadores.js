...
function ver(id)
{
    ...
    $.ajax({
        url: '../../php/educadores/detallesEducador.php',
        type: 'POST',
        data: parametros,
        beforeSend: function() {
            //$('#tblDatosEducadores').html('<tr><td colspan="4" class="text-center"><i class="fas fa-sync fa-2x fa-spin"></i></td></tr>');
        ...
        success: function(respuesta)
        {
            ...
            switch (respuesta)
            {
                ...
                default:
                    ...
                    $('#tdEscuela').html(edu.escuela);
                    $('#tdComentarios').html(edu.comentarios);
                    $('#tdGrado').html(edu.grado);
                    if (edu.status==0)
                    {
                        $('#alumnoTitle').hide();
                        $('#alumnoNombre').hide();
                    ...
                    else
                    {
                        ...
                        $('#alumnoCp').show();
                        $('#alumnoCol').show();
                        $('#tdAlumnoNombre').html(edu.nombreA);
                        $('#tdAlumnoSexo').html(edu.sexoA);
                        $('#tdAlumnoCalle').html(edu.calleA);
                        $('#tdAlumnoNumInt').html(edu.numIntA);
                        $('#tdAlumnoNumExt').html(edu.numExtA);
                        $('#tdAlumnoColonia').html(edu.colFraccA);
                        $('#tdAlumnoCp').html(edu.cpA);
                        $('#tdStatus').html("<p class='text-success'><strong>EDUCANDO <i class='fas fa-user-tie'></i></strong> </p>");
                    }
                    
                    break;
            }
            $('#modalDetallesEducador').modal('show');
        }
    });
}
var empleadoActual;
...
function agregar()
{
    ...
    $.ajax({
        url: '../../php/educadores/asignar.php',
        data: parametros,
        type: 'POST',
        beforeSend: function()
        {
